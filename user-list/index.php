...
<div class="container">
    <br><br>
    <div class="content">
        <button type="button" id="add_button" data-toggle="modal" data-target="#editModal" class="btn btn-success">Add
            User
        </button>
        <br><br>
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select class="js-example-basic-single" name="nr_Tel" id="nr_Tel"></select>
            </div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <img id="foto" src="http://localhost/Projekti/images/default.jpg" width="200px" height="200px"
